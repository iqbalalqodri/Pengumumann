 ...
 <?php 
        if (isset($_POST['submit'])) {
            ...
            $keterangan = $_POST['keterangan'];
             ...
             $sql="INSERT INTO as_pengumuman (nisn,nomor_peserta,nama,kelas_jurusan,keterangan)values('$nisn','$np','$nama','$kj','$keterangan')";

                if (mysqli_query($connect,$sql)) {
                    echo "<script type='text/javascript'>alert('Data Berhasil Di Tambah Ke Database!!');
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="Pengumuman_t.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <div class="col-sm-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="kj" type="text " placeholder="Masukan Kelas/Jurusan" required="">
                </div>

                <div class="form-group">
                    <label class="label-control" for="">NISN</label>
                    <input class="form-control" name="nisn" type="text " placeholder="Masukan nisn" required="">
                </div>

                <div class="form-group">
                    <label class="label-control" for="">NOMOR PESERTA</label>
                    <input class="form-control" name="np" type="text " placeholder="Masukan nomor peserta" required="">
                </div>
