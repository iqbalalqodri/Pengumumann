 ...
 <?php 
        if (isset($_POST['submit'])) {
            ...
            $level = $_POST['level'];
             ...
             $sql="INSERT INTO as_users (nama,username,password,level)values('$nama','$username','$password','$level')";
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="users_t.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tambah Users</p>
                </a>
              </li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tamabah Users</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="col-sm-12">
        <div class="col-sm-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="user" type="text " placeholder="Masukan Username" required="">
                </div>
                <div class="form-group">
                    <label class="label-control" for="">password</label>
                    <input class="form-control" name="pass" type="text " placeholder="Masukan password" required="">
                </div>
                 <div class="form-group">
