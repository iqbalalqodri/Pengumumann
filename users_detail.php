...
<head>
  ...
  <title>SMK N 1 LAHAT | Detail</title>
        ...
        <div class="col-sm-6">
            <form >
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="user" type="text " value="<?= $data['username'] ?>" readonly="">
                </div>
                <div class="form-group">
                    <label class="label-control" for="">password</label>
                    <input class="form-control" name="pass" type="text " value="<?= $data['password'] ?>" readonly="">
                </div>
                <div class="form-group">
                    <label class="label-control" for="">File</label>
                    <p><a href="Upload/<?= $data1['raport']; ?>" class="btn btn-primary">Lihat Raport</a></p>
